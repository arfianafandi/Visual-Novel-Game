...
monogatari.script ({
	...
	'Start': [
		...
		'centered Makhluk yang satu ini berukuran kerdil.',
		'centered Sepintas terlihat seperti bangsa manusia pada umumnya.',
		'nvl Memiliki janggut serta kumis yang panjang',
		'end'
	]
});